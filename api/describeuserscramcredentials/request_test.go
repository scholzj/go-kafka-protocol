...
// Round-trips a fully populated DescribeUserScramCredentialsRequest through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestDescribeUserScramCredentialsRequestRoundTrip(t *testing.T) {
	in := &DescribeUserScramCredentialsRequest{
		Users: &[]DescribeUserScramCredentialsRequestUser{DescribeUserScramCredentialsRequestUser{
			Name: reqPtr("x"),
		}},
	}
	...
	inNulls := &DescribeUserScramCredentialsRequest{
		Users: nil,
	}
	...
	for v := int16(0); v <= 0; v++ {
		{
			...
			out := &DescribeUserScramCredentialsRequest{}
		...
		_ = (&DescribeUserScramCredentialsRequest{}).PrettyPrint()
	}
}
