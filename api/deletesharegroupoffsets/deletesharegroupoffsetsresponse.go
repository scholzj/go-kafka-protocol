...
func (m *DeleteShareGroupOffsetsResponse) Write(w io.Writer, version int16) error {
	...
	if version >= 0 && version <= 999 {
		...
		encoder := func(item interface{}) ([]byte, error) {
			...
			structItem, ok := item.(DeleteShareGroupOffsetsResponseDeleteShareGroupOffsetsResponseTopic)
			if !ok {
...
func (m *DeleteShareGroupOffsetsResponse) Read(r io.Reader, version int16) error {
	...
	if version >= 0 && version <= 999 {
		...
		decoder := func(data []byte) (interface{}, int, error) {
			var elem DeleteShareGroupOffsetsResponseDeleteShareGroupOffsetsResponseTopic
		...
		if isFlexible {
			...
			for i := int32(0); i < length; i++ {
				...
				var elemBuf bytes.Buffer
				elemW := &elemBuf
				var tempElem DeleteShareGroupOffsetsResponseDeleteShareGroupOffsetsResponseTopic
				// TopicName
				if version >= 0 && version <= 999 {
					if isFlexible {
			...
			m.Responses = make([]DeleteShareGroupOffsetsResponseDeleteShareGroupOffsetsResponseTopic, len(decoded))
			for i, item := range decoded {
				m.Responses[i] = item.(DeleteShareGroupOffsetsResponseDeleteShareGroupOffsetsResponseTopic)
			}
		} else {
...
// writeTaggedFields writes tagged fields for DeleteShareGroupOffsetsResponseDeleteShareGroupOffsetsResponseTopic.
func (m *DeleteShareGroupOffsetsResponseDeleteShareGroupOffsetsResponseTopic) writeTaggedFields(w io.Writer, version int16) error {
...
// readTaggedFields reads tagged fields for DeleteShareGroupOffsetsResponseDeleteShareGroupOffsetsResponseTopic.
func (m *DeleteShareGroupOffsetsResponseDeleteShareGroupOffsetsResponseTopic) readTaggedFields(r io.Reader, version int16) error {
