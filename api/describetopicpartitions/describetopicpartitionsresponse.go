		...
		for i := range m.Topics {
			...
			if version >= 0 && version <= 999 {
				...
				for i := range m.Topics[i].Partitions {
					...
					if version >= 0 && version <= 999 {
						if m.Topics[i].Partitions[i].EligibleLeaderReplicas == nil {
							if isFlexible {
							...
							if isFlexible {
								length := uint32(len(m.Topics[i].Partitions[i].EligibleLeaderReplicas) + 1)
								if err := protocol.WriteVaruint32(w, length); err != nil {
									return err
								}
							} else {
								if err := protocol.WriteInt32(w, int32(len(m.Topics[i].Partitions[i].EligibleLeaderReplicas))); err != nil {
									return err
								}
							}
							for i := range m.Topics[i].Partitions[i].EligibleLeaderReplicas {
								if err := protocol.WriteInt32(w, m.Topics[i].Partitions[i].EligibleLeaderReplicas[i]); err != nil {
									return err
								}
								_ = i
							}
					...
					// LastKnownElr
					if version >= 0 && version <= 999 {
						if m.Topics[i].Partitions[i].LastKnownElr == nil {
							if isFlexible {
								if err := protocol.WriteVaruint32(w, 0); err != nil {
									return err
								}
							...
							if isFlexible {
								length := uint32(len(m.Topics[i].Partitions[i].LastKnownElr) + 1)
								if err := protocol.WriteVaruint32(w, length); err != nil {
									return err
								}
							} else {
								if err := protocol.WriteInt32(w, int32(len(m.Topics[i].Partitions[i].LastKnownElr))); err != nil {
									return err
								}
							}
							for i := range m.Topics[i].Partitions[i].LastKnownElr {
								if err := protocol.WriteInt32(w, m.Topics[i].Partitions[i].LastKnownElr[i]); err != nil {
									return err
								}
								_ = i
							}
...
func (m *DescribeTopicPartitionsResponse) Read(r io.Reader, version int16) error {
	...
	if version >= 0 && version <= 999 {
		...
		if isFlexible {
			...
			m.Topics = make([]DescribeTopicPartitionsResponseDescribeTopicPartitionsResponseTopic, length)
			for i := int32(0); i < length; i++ {
				...
				if version >= 0 && version <= 999 {
					...
					if isFlexible {
						...
						length = int32(lengthUint - 1)
						m.Topics[i].Partitions = make([]DescribeTopicPartitionsResponseDescribeTopicPartitionsResponsePartition, length)
						for i := int32(0); i < length; i++ {
							// ErrorCode
							if version >= 0 && version <= 999 {
								val, err := protocol.ReadInt16(r)
							...
							if version >= 0 && version <= 999 {
								...
								if isFlexible {
									...
									if lengthUint == 0 {
										m.Topics[i].Partitions[i].EligibleLeaderReplicas = nil
									} else {
										if lengthUint < 1 {
											return errors.New("invalid compact array length")
										}
										length = int32(lengthUint - 1)
										m.Topics[i].Partitions[i].EligibleLeaderReplicas = make([]int32, length)
										for i := int32(0); i < length; i++ {
											val, err := protocol.ReadInt32(r)
											if err != nil {
												return err
											}
											m.Topics[i].Partitions[i].EligibleLeaderReplicas[i] = val
										}
									}
								} else {
									var err error
							...
							if version >= 0 && version <= 999 {
								...
								if isFlexible {
									...
									if lengthUint == 0 {
										m.Topics[i].Partitions[i].LastKnownElr = nil
									} else {
										if lengthUint < 1 {
											return errors.New("invalid compact array length")
										}
										length = int32(lengthUint - 1)
										m.Topics[i].Partitions[i].LastKnownElr = make([]int32, length)
										for i := int32(0); i < length; i++ {
											val, err := protocol.ReadInt32(r)
											if err != nil {
												return err
											}
											m.Topics[i].Partitions[i].LastKnownElr[i] = val
										}
									}
								} else {
									var err error
