...
// Round-trips a fully populated DescribeTopicPartitionsRequest through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestDescribeTopicPartitionsRequestRoundTrip(t *testing.T) {
	in := &DescribeTopicPartitionsRequest{
		Topics: &[]DescribeTopicPartitionsRequestTopic{DescribeTopicPartitionsRequestTopic{
			Name: reqPtr("x"),
		}},
	...
	inNulls := &DescribeTopicPartitionsRequest{
		Topics: &[]DescribeTopicPartitionsRequestTopic{DescribeTopicPartitionsRequestTopic{
			Name: reqPtr("x"),
		}},
		ResponsePartitionLimit: 1,
	...
	for v := int16(0); v <= 0; v++ {
		{
			...
			out := &DescribeTopicPartitionsRequest{}
		...
		_ = (&DescribeTopicPartitionsRequest{}).PrettyPrint()
	}
}
