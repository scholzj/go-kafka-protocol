...
// Round-trips a fully populated ControllerRegistrationResponse through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestControllerRegistrationResponseRoundTrip(t *testing.T) {
	in := &ControllerRegistrationResponse{
		ThrottleTimeMs: 1,
		ErrorCode:      1,
	...
	inNulls := &ControllerRegistrationResponse{
		ThrottleTimeMs: 1,
		ErrorCode:      1,
		ErrorMessage:   nil,
	}
	...
	for v := int16(0); v <= 0; v++ {
		{
			...
			out := &ControllerRegistrationResponse{}
		...
		_ = (&ControllerRegistrationResponse{}).PrettyPrint()
	}
}
