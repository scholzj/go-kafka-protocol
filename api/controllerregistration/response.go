...
type ControllerRegistrationResponse struct {
	...
	ErrorMessage    *string // The response error message, or null if there was no error. (versions: 0+, nullable: 0+)
...
func (res *ControllerRegistrationResponse) Write(w io.Writer) error {
...
func (res *ControllerRegistrationResponse) Read(response *protocol.Response) error {
...
func (res *ControllerRegistrationResponse) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})

	fmt.Fprintf(w, "    <- ControllerRegistrationResponse:\n")
