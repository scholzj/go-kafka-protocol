...
func (m *OffsetDeleteResponse) Write(w io.Writer, version int16) error {
	...
	if version >= 0 && version <= 999 {
		...
		encoder := func(item interface{}) ([]byte, error) {
			...
			structItem, ok := item.(OffsetDeleteResponseOffsetDeleteResponseTopic)
			if !ok {
...
func (m *OffsetDeleteResponse) Read(r io.Reader, version int16) error {
	...
	if version >= 0 && version <= 999 {
		...
		decoder := func(data []byte) (interface{}, int, error) {
			var elem OffsetDeleteResponseOffsetDeleteResponseTopic
		...
		if isFlexible {
			...
			for i := int32(0); i < length; i++ {
				...
				var elemBuf bytes.Buffer
				elemW := &elemBuf
				var tempElem OffsetDeleteResponseOffsetDeleteResponseTopic
				// Name
				if version >= 0 && version <= 999 {
					if isFlexible {
				...
				if version >= 0 && version <= 999 {
					// Decode array using ArrayDecoder
					decoder := func(data []byte) (interface{}, int, error) {
						var elem OffsetDeleteResponseOffsetDeleteResponsePartition
						elemR := bytes.NewReader(data)
						// PartitionIndex
						if version >= 0 && version <= 999 {
					...
					if isFlexible {
						...
						for i := int32(0); i < length; i++ {
							...
							var elemBuf bytes.Buffer
							elemW := &elemBuf
							var tempElem OffsetDeleteResponseOffsetDeleteResponsePartition
							// PartitionIndex
							if version >= 0 && version <= 999 {
								val, err := protocol.ReadInt32(r)
								if err != nil {
						...
						tempElem.Partitions = make([]OffsetDeleteResponseOffsetDeleteResponsePartition, len(decoded))
						for i, item := range decoded {
							tempElem.Partitions[i] = item.(OffsetDeleteResponseOffsetDeleteResponsePartition)
						}
					} else {
			...
			// Convert []interface{} to typed slice
			m.Topics = make([]OffsetDeleteResponseOffsetDeleteResponseTopic, len(decoded))
			for i, item := range decoded {
				m.Topics[i] = item.(OffsetDeleteResponseOffsetDeleteResponseTopic)
			}
		} else {
			length, err := protocol.ReadInt32(r)
			if err != nil {
...
// writeTaggedFields writes tagged fields for OffsetDeleteResponseOffsetDeleteResponseTopic.
func (m *OffsetDeleteResponseOffsetDeleteResponseTopic) writeTaggedFields(w io.Writer, version int16) error {
...
// readTaggedFields reads tagged fields for OffsetDeleteResponseOffsetDeleteResponseTopic.
func (m *OffsetDeleteResponseOffsetDeleteResponseTopic) readTaggedFields(r io.Reader, version int16) error {
...
// writeTaggedFields writes tagged fields for OffsetDeleteResponseOffsetDeleteResponsePartition.
func (m *OffsetDeleteResponseOffsetDeleteResponsePartition) writeTaggedFields(w io.Writer, version int16) error {
	var taggedFieldsCount int
	var taggedFieldsBuf bytes.Buffer
...
// readTaggedFields reads tagged fields for OffsetDeleteResponseOffsetDeleteResponsePartition.
func (m *OffsetDeleteResponseOffsetDeleteResponsePartition) readTaggedFields(r io.Reader, version int16) error {
	// Read tagged fields count
	count, err := protocol.ReadVaruint32(r)
	if err != nil {
		return err
