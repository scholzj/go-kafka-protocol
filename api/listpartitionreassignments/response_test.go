...
// Round-trips a fully populated ListPartitionReassignmentsResponse through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestListPartitionReassignmentsResponseRoundTrip(t *testing.T) {
	in := &ListPartitionReassignmentsResponse{
		ThrottleTimeMs: 1,
		ErrorCode:      1,
		ErrorMessage:   resPtr("x"),
		Topics: &[]ListPartitionReassignmentsResponseTopic{ListPartitionReassignmentsResponseTopic{
			Name: resPtr("x"),
			Partitions: &[]ListPartitionReassignmentsResponseTopicPartition{ListPartitionReassignmentsResponseTopicPartition{
				PartitionIndex:   1,
				Replicas:         &[]int32{1},
				AddingReplicas:   &[]int32{1},
				RemovingReplicas: &[]int32{1},
			}},
		}},
	}
	...
	inNulls := &ListPartitionReassignmentsResponse{
		ThrottleTimeMs: 1,
		ErrorCode:      1,
		ErrorMessage:   nil,
		Topics: &[]ListPartitionReassignmentsResponseTopic{ListPartitionReassignmentsResponseTopic{
	...
	for v := int16(0); v <= 0; v++ {
		{
			...
			out := &ListPartitionReassignmentsResponse{}
		...
		_ = (&ListPartitionReassignmentsResponse{}).PrettyPrint()
	}
}
