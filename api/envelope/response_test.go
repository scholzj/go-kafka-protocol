...
// Round-trips a fully populated EnvelopeResponse through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestEnvelopeResponseRoundTrip(t *testing.T) {
	in := &EnvelopeResponse{
		ResponseData: &[]byte{1, 2, 3},
		ErrorCode:    1,
	}
	...
	for v := int16(0); v <= 0; v++ {
		...
		_ = (&EnvelopeResponse{}).PrettyPrint()
	}
}
