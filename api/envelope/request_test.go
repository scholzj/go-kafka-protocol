...
// Round-trips a fully populated EnvelopeRequest through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestEnvelopeRequestRoundTrip(t *testing.T) {
	in := &EnvelopeRequest{
		RequestData:       &[]byte{1, 2, 3},
		RequestPrincipal:  &[]byte{1, 2, 3},
		ClientHostAddress: &[]byte{1, 2, 3},
	}
