...
// Round-trips a fully populated DescribeAclsRequest through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestDescribeAclsRequestRoundTrip(t *testing.T) {
	in := &DescribeAclsRequest{
	...
	for v := int16(1); v <= 3; v++ {
		...
		_ = (&DescribeAclsRequest{}).PrettyPrint()
	}
}
