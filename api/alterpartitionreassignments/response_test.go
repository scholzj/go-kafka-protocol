...
// Round-trips a fully populated AlterPartitionReassignmentsResponse through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestAlterPartitionReassignmentsResponseRoundTrip(t *testing.T) {
	in := &AlterPartitionReassignmentsResponse{
		ThrottleTimeMs:               1,
