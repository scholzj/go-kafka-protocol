...
// Round-trips a fully populated AlterPartitionReassignmentsRequest through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestAlterPartitionReassignmentsRequestRoundTrip(t *testing.T) {
	in := &AlterPartitionReassignmentsRequest{
		TimeoutMs:                    1,
		AllowReplicationFactorChange: true,
		Topics: &[]AlterPartitionReassignmentsRequestTopic{AlterPartitionReassignmentsRequestTopic{
			Name: reqPtr("x"),
			Partitions: &[]AlterPartitionReassignmentsRequestTopicPartition{AlterPartitionReassignmentsRequestTopicPartition{
				PartitionIndex: 1,
				Replicas:       &[]int32{1},
			}},
		}},
	...
	inNulls := &AlterPartitionReassignmentsRequest{
		TimeoutMs:                    1,
		AllowReplicationFactorChange: true,
		Topics: &[]AlterPartitionReassignmentsRequestTopic{AlterPartitionReassignmentsRequestTopic{
			Name: reqPtr("x"),
	...
	for v := int16(0); v <= 1; v++ {
		{
			...
			out := &AlterPartitionReassignmentsRequest{}
		...
		_ = (&AlterPartitionReassignmentsRequest{}).PrettyPrint()
	}
}
