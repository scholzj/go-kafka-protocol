...
// Round-trips a fully populated AddRaftVoterResponse through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestAddRaftVoterResponseRoundTrip(t *testing.T) {
	in := &AddRaftVoterResponse{
		ThrottleTimeMs: 1,
		ErrorCode:      1,
	...
	for v := int16(0); v <= 1; v++ {
		...
		_ = (&AddRaftVoterResponse{}).PrettyPrint()
	}
}
