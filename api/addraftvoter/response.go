...
func (res *AddRaftVoterResponse) Write(w io.Writer) error {
...
func (res *AddRaftVoterResponse) Read(response *protocol.Response) error {
	if response == nil || response.Body == nil {
		return fmt.Errorf("AddRaftVoterResponse.Read: response or its body is nil")
	}

	*res = AddRaftVoterResponse{}
...
func (res *AddRaftVoterResponse) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})

	fmt.Fprintf(w, "    <- AddRaftVoterResponse:\n")
