...
func (res *RemoveRaftVoterResponse) Write(w io.Writer) error {
...
func (res *RemoveRaftVoterResponse) Read(response *protocol.Response) error {
...
func (res *RemoveRaftVoterResponse) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})

	fmt.Fprintf(w, "    <- RemoveRaftVoterResponse:\n")
