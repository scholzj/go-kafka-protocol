...
// Round-trips a fully populated SyncGroupResponse through Write/Read/Write at every
...
func TestSyncGroupResponseRoundTrip(t *testing.T) {
	...
	for v := int16(0); v <= 5; v++ {
		...
		_ = (&SyncGroupResponse{}).PrettyPrint()
	}
}
