...
// Round-trips a fully populated SaslHandshakeRequest through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestSaslHandshakeRequestRoundTrip(t *testing.T) {
	in := &SaslHandshakeRequest{
		Mechanism: reqPtr("x"),
	}
	...
	for v := int16(0); v <= 0; v++ {
		...
		_ = in.PrettyPrint()
		_ = (&SaslHandshakeRequest{}).PrettyPrint()
	}
}
