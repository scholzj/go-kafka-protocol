...
// Round-trips a fully populated SaslHandshakeResponse through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestSaslHandshakeResponseRoundTrip(t *testing.T) {
	in := &SaslHandshakeResponse{
		ErrorCode:  1,
		Mechanisms: &[]string{"x"},
	}
	...
	for v := int16(0); v <= 0; v++ {
		...
		_ = in.PrettyPrint()
		_ = (&SaslHandshakeResponse{}).PrettyPrint()
	}
}
