...
// Round-trips a fully populated AddOffsetsToTxnRequest through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestAddOffsetsToTxnRequestRoundTrip(t *testing.T) {
	in := &AddOffsetsToTxnRequest{
	...
	for v := int16(0); v <= 3; v++ {
		...
		_ = in.PrettyPrint()
		_ = (&AddOffsetsToTxnRequest{}).PrettyPrint()
	}
}
