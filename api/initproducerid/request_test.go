...
// Round-trips a fully populated InitProducerIdRequest through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestInitProducerIdRequestRoundTrip(t *testing.T) {
	in := &InitProducerIdRequest{
	...
	for v := int16(0); v <= 6; v++ {
		...
		_ = (&InitProducerIdRequest{}).PrettyPrint()
	}
}
