...
func (res *RenewDelegationTokenResponse) Write(w io.Writer) error {
...
func (res *RenewDelegationTokenResponse) Read(response *protocol.Response) error {
...
func (res *RenewDelegationTokenResponse) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})

	fmt.Fprintf(w, "    <- RenewDelegationTokenResponse:\n")
