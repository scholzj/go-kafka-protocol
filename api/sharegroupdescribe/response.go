...
type ShareGroupDescribeResponse struct {
	...
	Groups          *[]ShareGroupDescribeResponseGroup // Each described group. (versions: 0+)
...
type ShareGroupDescribeResponseGroup struct {
	...
	Members              *[]ShareGroupDescribeResponseGroupMember // The members. (versions: 0+)
...
type ShareGroupDescribeResponseGroupMember struct {
	...
	Assignment           *ShareGroupDescribeResponseGroupMemberAssignment // The current assignment. (versions: 0+)
	rawTaggedFields      *[]protocol.TaggedField
}

type ShareGroupDescribeResponseGroupMemberAssignment struct {
	TopicPartitions *[]ShareGroupDescribeResponseGroupMemberAssignmentTopicPartition // The assigned topic-partitions to the member. (versions: 0+)
	rawTaggedFields *[]protocol.TaggedField
}
...
func (res *ShareGroupDescribeResponse) Write(w io.Writer) error {
	...
	// Groups (versions: 0+)
	if res.Groups == nil {
		return fmt.Errorf("ShareGroupDescribeResponse.Groups must not be nil in version %d", res.ApiVersion)
	}
...
func (res *ShareGroupDescribeResponse) Read(response *protocol.Response) error {
...
func (res *ShareGroupDescribeResponse) groupsEncoder(w io.Writer, value ShareGroupDescribeResponseGroup) error {
	...
	if value.GroupId == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroup.GroupId must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
	...
	if value.GroupState == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroup.GroupState must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
	...
	if value.AssignorName == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroup.AssignorName must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
	...
	if value.Members == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroup.Members must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
...
func (res *ShareGroupDescribeResponse) groupsDecoder(r io.Reader) (ShareGroupDescribeResponseGroup, error) {
	...
	sharegroupdescriberesponsegroup.ErrorCode = errorcode
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroup.ErrorMessage = errormessage
	} else {
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroup.GroupId = &groupid
	} else {
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroup.GroupState = &groupstate
	} else {
	...
	sharegroupdescriberesponsegroup.GroupEpoch = groupepoch
	...
	sharegroupdescriberesponsegroup.AssignmentEpoch = assignmentepoch
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroup.AssignorName = &assignorname
	} else {
	...
	sharegroupdescriberesponsegroup.AuthorizedOperations = authorizedoperations
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroup.rawTaggedFields = &rawTaggedFields
	}

	return sharegroupdescriberesponsegroup, nil
}

func (res *ShareGroupDescribeResponse) membersEncoder(w io.Writer, value ShareGroupDescribeResponseGroupMember) error {
	// MemberId (versions: 0+)
	if value.MemberId == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroupMember.MemberId must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
	...
	if value.ClientId == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroupMember.ClientId must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
	...
	if value.ClientHost == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroupMember.ClientHost must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
	...
	if value.SubscribedTopicNames == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroupMember.SubscribedTopicNames must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
	...
	if value.Assignment == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroupMember.Assignment must not be nil in version %d", res.ApiVersion)
	}
...
func (res *ShareGroupDescribeResponse) membersDecoder(r io.Reader) (ShareGroupDescribeResponseGroupMember, error) {
	sharegroupdescriberesponsegroupmember := ShareGroupDescribeResponseGroupMember{}
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroupmember.MemberId = &memberid
	} else {
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroupmember.RackId = rackid
	} else {
	...
	sharegroupdescriberesponsegroupmember.MemberEpoch = memberepoch
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroupmember.ClientId = &clientid
	} else {
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroupmember.ClientHost = &clienthost
	} else {
	...
	sharegroupdescriberesponsegroupmember.Assignment = &assignment
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroupmember.rawTaggedFields = &rawTaggedFields
	}

	return sharegroupdescriberesponsegroupmember, nil
}

func (res *ShareGroupDescribeResponse) assignmentEncoder(w io.Writer, value ShareGroupDescribeResponseGroupMemberAssignment) error {
	// TopicPartitions (versions: 0+)
	if value.TopicPartitions == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroupMemberAssignment.TopicPartitions must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
...
func (res *ShareGroupDescribeResponse) assignmentDecoder(r io.Reader) (ShareGroupDescribeResponseGroupMemberAssignment, error) {
	sharegroupdescriberesponsegroupmemberassignment := ShareGroupDescribeResponseGroupMemberAssignment{}
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroupmemberassignment.rawTaggedFields = &rawTaggedFields
	}

	return sharegroupdescriberesponsegroupmemberassignment, nil
}

func (res *ShareGroupDescribeResponse) topicPartitionsEncoder(w io.Writer, value ShareGroupDescribeResponseGroupMemberAssignmentTopicPartition) error {
	// TopicId (versions: 0+)
	...
	if value.TopicName == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroupMemberAssignmentTopicPartition.TopicName must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
	...
	if value.Partitions == nil {
		return fmt.Errorf("ShareGroupDescribeResponseGroupMemberAssignmentTopicPartition.Partitions must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
...
func (res *ShareGroupDescribeResponse) topicPartitionsDecoder(r io.Reader) (ShareGroupDescribeResponseGroupMemberAssignmentTopicPartition, error) {
	sharegroupdescriberesponsegroupmemberassignmenttopicpartition := ShareGroupDescribeResponseGroupMemberAssignmentTopicPartition{}
	...
	sharegroupdescriberesponsegroupmemberassignmenttopicpartition.TopicId = topicid
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroupmemberassignmenttopicpartition.TopicName = &topicname
	} else {
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		sharegroupdescriberesponsegroupmemberassignmenttopicpartition.rawTaggedFields = &rawTaggedFields
	}

	return sharegroupdescriberesponsegroupmemberassignmenttopicpartition, nil
}

//goland:noinspection GoUnhandledErrorResult
func (res *ShareGroupDescribeResponse) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})

	fmt.Fprintf(w, "    <- ShareGroupDescribeResponse:\n")
...
//goland:noinspection GoUnhandledErrorResult
func (value *ShareGroupDescribeResponseGroup) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})
...
//goland:noinspection GoUnhandledErrorResult
func (value *ShareGroupDescribeResponseGroupMember) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})
...
//goland:noinspection GoUnhandledErrorResult
func (value *ShareGroupDescribeResponseGroupMemberAssignment) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})
...
//goland:noinspection GoUnhandledErrorResult
func (value *ShareGroupDescribeResponseGroupMemberAssignmentTopicPartition) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})
