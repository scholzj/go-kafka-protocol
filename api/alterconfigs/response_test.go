...
// Round-trips a fully populated AlterConfigsResponse through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestAlterConfigsResponseRoundTrip(t *testing.T) {
	in := &AlterConfigsResponse{
		ThrottleTimeMs: 1,
		Responses: &[]AlterConfigsResponseResponse{AlterConfigsResponseResponse{
			ErrorCode:    1,
	...
	for v := int16(0); v <= 2; v++ {
		...
		_ = (&AlterConfigsResponse{}).PrettyPrint()
	}
}
