...
type AlterConfigsResponse struct {
	...
	Responses       *[]AlterConfigsResponseResponse // The responses for each resource. (versions: 0+)
	rawTaggedFields *[]protocol.TaggedField
}

type AlterConfigsResponseResponse struct {
...
func (res *AlterConfigsResponse) Write(w io.Writer) error {
	...
	if res.Responses == nil {
		return fmt.Errorf("AlterConfigsResponse.Responses must not be nil in version %d", res.ApiVersion)
	}
...
func (res *AlterConfigsResponse) Read(response *protocol.Response) error {
	if response == nil || response.Body == nil {
		return fmt.Errorf("AlterConfigsResponse.Read: response or its body is nil")
	}
...
func (res *AlterConfigsResponse) responsesEncoder(w io.Writer, value AlterConfigsResponseResponse) error {
	...
	if value.ResourceName == nil {
		return fmt.Errorf("AlterConfigsResponseResponse.ResourceName must not be nil in version %d", res.ApiVersion)
	}
	if isResponseFlexible(res.ApiVersion) {
...
func (res *AlterConfigsResponse) responsesDecoder(r io.Reader) (AlterConfigsResponseResponse, error) {
	alterconfigsresponseresponse := AlterConfigsResponseResponse{}

	// ErrorCode (versions: 0+)
	errorcode, err := protocol.ReadInt16(r)
	if err != nil {
		return alterconfigsresponseresponse, err
	}
	alterconfigsresponseresponse.ErrorCode = errorcode
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		alterconfigsresponseresponse.ErrorMessage = errormessage
	} else {
	...
	alterconfigsresponseresponse.ResourceType = resourcetype
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		alterconfigsresponseresponse.ResourceName = &resourcename
	} else {
	...
	if isResponseFlexible(res.ApiVersion) {
		...
		alterconfigsresponseresponse.rawTaggedFields = &rawTaggedFields
	}

	return alterconfigsresponseresponse, nil
}

//goland:noinspection GoUnhandledErrorResult
func (res *AlterConfigsResponse) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})

	fmt.Fprintf(w, "    <- AlterConfigsResponse:\n")
...
//goland:noinspection GoUnhandledErrorResult
func (value *AlterConfigsResponseResponse) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})
