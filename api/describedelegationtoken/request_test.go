...
// Round-trips a fully populated DescribeDelegationTokenRequest through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestDescribeDelegationTokenRequestRoundTrip(t *testing.T) {
	in := &DescribeDelegationTokenRequest{
		Owners: &[]DescribeDelegationTokenRequestOwner{DescribeDelegationTokenRequestOwner{
	...
	inNulls := &DescribeDelegationTokenRequest{
		Owners: nil,
	}
	...
	for v := int16(1); v <= 3; v++ {
		{
			...
			out := &DescribeDelegationTokenRequest{}
		...
		_ = (&DescribeDelegationTokenRequest{}).PrettyPrint()
	}
}
