...
func (res *PushTelemetryResponse) Write(w io.Writer) error {
...
func (res *PushTelemetryResponse) Read(response *protocol.Response) error {
...
func (res *PushTelemetryResponse) PrettyPrint() string {
	w := bytes.NewBuffer([]byte{})

	fmt.Fprintf(w, "    <- PushTelemetryResponse:\n")
