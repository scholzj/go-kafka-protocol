...
func (m *AlterShareGroupOffsetsRequest) Write(w io.Writer, version int16) error {
	...
	if version >= 0 && version <= 999 {
		...
		encoder := func(item interface{}) ([]byte, error) {
			...
			structItem, ok := item.(AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestTopic)
			if !ok {
...
func (m *AlterShareGroupOffsetsRequest) Read(r io.Reader, version int16) error {
	...
	if version >= 0 && version <= 999 {
		...
		decoder := func(data []byte) (interface{}, int, error) {
			var elem AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestTopic
		...
		if isFlexible {
			...
			for i := int32(0); i < length; i++ {
				...
				var elemBuf bytes.Buffer
				elemW := &elemBuf
				var tempElem AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestTopic
				// TopicName
				if version >= 0 && version <= 999 {
					if isFlexible {
						val, err := protocol.ReadCompactString(r)
				...
				if version >= 0 && version <= 999 {
					// Decode array using ArrayDecoder
					decoder := func(data []byte) (interface{}, int, error) {
						var elem AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestPartition
						elemR := bytes.NewReader(data)
						// PartitionIndex
						if version >= 0 && version <= 999 {
					...
					if isFlexible {
						...
						for i := int32(0); i < length; i++ {
							...
							var elemBuf bytes.Buffer
							elemW := &elemBuf
							var tempElem AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestPartition
							// PartitionIndex
							if version >= 0 && version <= 999 {
						...
						tempElem.Partitions = make([]AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestPartition, len(decoded))
						for i, item := range decoded {
							tempElem.Partitions[i] = item.(AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestPartition)
						}
					} else {
			...
			// Convert []interface{} to typed slice
			m.Topics = make([]AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestTopic, len(decoded))
			for i, item := range decoded {
				m.Topics[i] = item.(AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestTopic)
			}
		} else {
			length, err := protocol.ReadInt32(r)
			if err != nil {
...
// writeTaggedFields writes tagged fields for AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestTopic.
func (m *AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestTopic) writeTaggedFields(w io.Writer, version int16) error {
...
// readTaggedFields reads tagged fields for AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestTopic.
func (m *AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestTopic) readTaggedFields(r io.Reader, version int16) error {
...
// writeTaggedFields writes tagged fields for AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestPartition.
func (m *AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestPartition) writeTaggedFields(w io.Writer, version int16) error {
	var taggedFieldsCount int
	var taggedFieldsBuf bytes.Buffer
...
// readTaggedFields reads tagged fields for AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestPartition.
func (m *AlterShareGroupOffsetsRequestAlterShareGroupOffsetsRequestPartition) readTaggedFields(r io.Reader, version int16) error {
	// Read tagged fields count
	count, err := protocol.ReadVaruint32(r)
	if err != nil {
		return err
