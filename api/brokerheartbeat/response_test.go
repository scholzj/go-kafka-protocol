...
// Round-trips a fully populated BrokerHeartbeatResponse through Write/Read/Write at every
// valid protocol version and checks the re-encoded bytes match.
func TestBrokerHeartbeatResponseRoundTrip(t *testing.T) {
	in := &BrokerHeartbeatResponse{
		ThrottleTimeMs: 1,
		ErrorCode:      1,
		IsCaughtUp:     true,
		IsFenced:       true,
	...
	for v := int16(0); v <= 0; v++ {
		...
		_ = in.PrettyPrint()
		_ = (&BrokerHeartbeatResponse{}).PrettyPrint()
	}
}
